      ...
      children: [
                        ...
                        children: [
                          ...
                          Visibility(
                              ...
                              child: GestureDetector(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      CustomTextFormField(
                                                          ...
                                                          hint: 'رقم تلفون',
                                                          width: 200,
                                                          controller: vm.TED_callReason),
                                                      ElevatedButton(
                                                          onPressed: () {
                                                            if (vm.validate()) {
                                                              context.read<HiveDB>().shosenCustomer!.mobilenum.add(vm.TED_callReason.text);
                                  ...
                                  child: const Icon(color: Colors.blue, Icons.add))),
                        ],
                      ),
                    ),
                    Padding(
                                ...
                                content: SizedBox(
                                  ...
                                  child: Form(
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        children: [
                                          ...customer.mobilenum.map((e) => TextButton(
                                                onPressed: () {
                                                ...
                                                child: Container(
                                                    decoration:
                                                        BoxDecoration(border: Border.all(), borderRadius: BorderRadius.circular(9), color: const Color.fromARGB(66, 137, 244, 219)),
                                                    child: Padding(
                                          ...
                                          const Gap(11),
                                          SearchWithSugestions(        validator: (p0) {
       if (g.keys.where((element) => element==p0,).isEmpty) {
         ...
         return null;
                                            ...
                                            TEC_forgovernmoate: vm.TED_governomate,
                                            onSubmitted: (v) {
                                              FocusScope.of(context).nextFocus();
                                            },
                                          ),
                                          const Gap(11),
                                          SearchWithSugestions(              validator: (p1) {
       if (g.values.expand((e) => e,).toList().where((element) => element==p1,).isEmpty) {
         ...
         return null;
                                            ...
                                            autofocus: false,
                                            labal: 'المنظقه',
                                            listOfsugestions: g[vm.TED_governomate.text]??[],
                                            TEC_forgovernmoate: vm.TED_area,
                                            onSubmitted: (v) {
                                              FocusScope.of(context).nextFocus();
                                            },
                                          ),
                                          ...
                                          ElevatedButton(
                                              onPressed: () {
                                                if (vm.validate()) {
                                                  context.read<HiveDB>().shosenCustomer!.covernorate = vm.TED_governomate.text;
                                                  context.read<HiveDB>().shosenCustomer!.area = vm.TED_area.text;
                                                  context.read<HiveDB>().shosenCustomer!.adress = vm.TED_adress.text;
                                                  context.read<HiveDB>().shosenCustomer!.cusotmerName = vm.TED_customerName.text;
                                                  context.read<HiveDB>().updatecustomer(context.read<HiveDB>().shosenCustomer!);
                                                  Navigator.of(context).pop();
                                                }
                                              },
